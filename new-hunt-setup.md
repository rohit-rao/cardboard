...
Cardboard expects a hunt Google Drive folder to already be set up with a template spreadsheet in it (from which puzzle spreadsheets will be cloned). Cardboard uses the list of users who have access to the Google Drive folder as the allowlist for authorizing users on login.
